...
export default function ListaProductosPage() {
  ...
  return (
    <div className="min-h-screen p-8 bg-gray-900 text-gray-100 rounded">
      ...
      <div className="md:hidden flex flex-col gap-4">
        {filtered.map((p) => {
          return (
            <ProductoCard key={p._id} product={p} onDelete={()=>{}} />
          )
        })}
      </div>
              ...
              <tbody>
                {filtered.map((p) => (
                  ...
                  >
                    ...
                    <td className="p-3">
                      <span
                        className={`px-2 py-1 rounded text-xs font-semibold ${p.featured === true
                    ...
                    <td className="p-3">
                      <span
                        className={`px-2 py-1 rounded text-xs font-semibold ${p.active === true
                          ? 'bg-green-100 text-green-700'
                          : 'bg-gray-200 text-gray-700'
                          }`}
                      >
